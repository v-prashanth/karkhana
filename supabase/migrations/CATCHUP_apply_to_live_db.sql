...
-- ============================================================
-- MIGRATION 19: JOB WORK MANAGEMENT & MATERIAL LIABILITY TRACKER
-- (Appended to catchup — run this section if not already applied)
-- ============================================================
...
-- 4. MATERIAL LIABILITY AGING ALERTS
